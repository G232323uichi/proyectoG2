...
<div class="container">
  <div class="row">
    <div class="col-xl-12">
     ...
     <!--/*****************  BOTON  DE  SALIR ******************************************/-->
 <?php
            echo form_open_multipart('estudiante/index2');
 ...
 ?>
<!--/***************** ***********************************************************/-->
     <div class="p-2 mb-2 bg-primary text-white"align="center">MODIFICAR REGISTRO DEL PROFESOR</div> 
<?php 

foreach ($infousuario->result() as $row)
{
  //echo form_open_multipart('estudiante/USUmodificarbased')  esto es de  usuario
   echo form_open_multipart('usuarios/USUAmodificarbased')
